#!/bin/bash
# Developers : <ALIF FUSOBAR> - <master@itsecurity.id> - <Xcod3bughunt3r> - <https://www.itsecurity.id>
...
clear
echo "=================================================================";
echo " Pangeran-Web (Ubuntu 16.04)               ";
echo " Developers : ALIF FUSOBAR - www.itsecurity.id                              ";
echo " Version 1.0 - 10/08/2022                                      ";
echo "=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=";
...
2)  echo -n "Masukkan alamat domain / subdomain : "
    ...
    echo "Selamat datang di web pangeran" >> /home/$namadomain/public_html/index.html
    ...
    sudo cp domain.conf /etc/apache2/sites-available/$namadomain.conf
...
echo ""
echo "Pangeran-Web"
echo "Oleh ALIF FUSOBAR - master@itsecurity.id"
echo ""
